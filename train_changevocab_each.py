...
from multi_class_data_loader_each import MultiClassDataLoader
...
tf.flags.DEFINE_string("filter_sizes", "2,8", "Comma-separated filter sizes (default: '3,4,5')")
...
tf.flags.DEFINE_string("activation_function", "elu",
                       "select activation_function (default: 'relu'), leaky_relu, elu, swish")
...
try:
    ...
    print("{}\n ...failed restore data\n New data - transform train, dev data...".format(
...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        ...
        batches = data_helpers.batch_iter(
            list(allY), FLAGS.batch_size, FLAGS.num_epochs)
