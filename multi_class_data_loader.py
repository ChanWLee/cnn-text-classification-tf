...
class MultiClassDataLoader(object):
    ...
    def define_flags(self):
        ...
        self.__flags.DEFINE_string("train_data_file", "./twitter/edit6_emo6_mf20", "Data source for the training data.")
        #self.__flags.DEFINE_string("train_data_file", "./twitter/edit1_pad_mf20", "Data source for the training data.")
        #self.__flags.DEFINE_string("train_data_file", "./twitter/edit1_pno_mf20", "Data source for the training data.")
        #self.__flags.DEFINE_string("train_data_file", "./twitter/eng_pn", "Data source for the training data.")
        ...
        #self.__flags.DEFINE_string("dev_data_file", "./twitter/eng_pn_dev", "Data source for cross validation data.")
        #self.__flags.DEFINE_string("dev_data_file", "./twitter/edit1_pno_dev", "Data source for cross validation data.")
        #self.__flags.DEFINE_string("dev_data_file", "./twitter/edit1_pad_dev", "Data source for cross validation data.")
        self.__flags.DEFINE_string("dev_data_file", "./twitter/edit6_emo6_dev", "Data source for cross validation data.")
        ...
        #self.__flags.DEFINE_string("class_data_file", "./twitter/classes_3.cls", "Data source for the class list.")
